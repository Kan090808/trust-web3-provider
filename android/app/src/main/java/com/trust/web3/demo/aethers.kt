...
class ChainProvider(
    pointer: Pointer
) : FFIObject(pointer), ChainProviderInterface {
...
public object FfiConverterTypeChainProvider: FfiConverter<ChainProvider, Pointer> {
    override fun lower(value: ChainProvider): Pointer = value.callWithPointer { it }

    override fun lift(value: Pointer): ChainProvider {
        return ChainProvider(value)
    }

    override fun read(buf: ByteBuffer): ChainProvider {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: ChainProvider) = 8

    override fun write(value: ChainProvider, buf: ByteBuffer) {
...
sealed class ProviderException(message: String): Exception(message) {
        ...
        class Runtime(message: String) : ProviderException(message)
        class Parse(message: String) : ProviderException(message)
        class Inner(message: String) : ProviderException(message)
        class FromAddressMissing(message: String) : ProviderException(message)
        

    companion object ErrorHandler : CallStatusErrorHandler<ProviderException> {
...
public object FfiConverterTypeProviderError : FfiConverterRustBuffer<ProviderException> {
    override fun read(buf: ByteBuffer): ProviderException {
            ...
            1 -> ProviderException.Runtime(FfiConverterString.read(buf))
            2 -> ProviderException.Parse(FfiConverterString.read(buf))
            3 -> ProviderException.Inner(FfiConverterString.read(buf))
            4 -> ProviderException.FromAddressMissing(FfiConverterString.read(buf))
            else -> throw RuntimeException("invalid error enum value, something is very wrong!!")
        }
        
    }

    override fun allocationSize(value: ProviderException): Int {
        return 4
    }

    override fun write(value: ProviderException, buf: ByteBuffer) {
        when(value) {
            is ProviderException.Runtime -> {
                buf.putInt(1)
                Unit
            }
            is ProviderException.Parse -> {
                buf.putInt(2)
                Unit
            }
            is ProviderException.Inner -> {
                buf.putInt(3)
                Unit
            }
            is ProviderException.FromAddressMissing -> {
                buf.putInt(4)
                Unit
            }
...
sealed class WalletException(message: String): Exception(message) {
        // Each variant is a nested class
        // Flat enums carries a string error message, so no special implementation is necessary.
        class DerivationParse(message: String) : WalletException(message)
        class Mnemonic(message: String) : WalletException(message)
        class Signature(message: String) : WalletException(message)
        class Serde(message: String) : WalletException(message)
        class Encrypt(message: String) : WalletException(message)
        class Decrypt(message: String) : WalletException(message)
        class Utf8(message: String) : WalletException(message)
        class WrongPassword(message: String) : WalletException(message)
...
public object FfiConverterTypeWalletError : FfiConverterRustBuffer<WalletException> {
    override fun read(buf: ByteBuffer): WalletException {
            ...
            return when(buf.getInt()) {
            1 -> WalletException.DerivationParse(FfiConverterString.read(buf))
            2 -> WalletException.Mnemonic(FfiConverterString.read(buf))
            3 -> WalletException.Signature(FfiConverterString.read(buf))
            4 -> WalletException.Serde(FfiConverterString.read(buf))
            5 -> WalletException.Encrypt(FfiConverterString.read(buf))
            6 -> WalletException.Decrypt(FfiConverterString.read(buf))
            7 -> WalletException.Utf8(FfiConverterString.read(buf))
            8 -> WalletException.WrongPassword(FfiConverterString.read(buf))
    ...
    override fun write(value: WalletException, buf: ByteBuffer) {
        when(value) {
            is WalletException.DerivationParse -> {
                buf.putInt(1)
                Unit
            }
            is WalletException.Mnemonic -> {
                buf.putInt(2)
                Unit
            }
            is WalletException.Signature -> {
                buf.putInt(3)
                Unit
            }
            is WalletException.Serde -> {
                buf.putInt(4)
                Unit
            }
            is WalletException.Encrypt -> {
                buf.putInt(5)
                Unit
            }
            is WalletException.Decrypt -> {
                buf.putInt(6)
                Unit
            }
            is WalletException.Utf8 -> {
                buf.putInt(7)
                Unit
            }
            is WalletException.WrongPassword -> {
                buf.putInt(8)
                Unit
            }
            is WalletException.EthSignature -> {
                buf.putInt(9)
                Unit
            }
            is WalletException.Provider -> {
                buf.putInt(10)
                Unit
            }
